...
function Cadastro() {
    ...
    // Estado para armazenar a resposta da API após o cadastro do usuário
    ...
    // Hook de efeito que navega para a página de login se o usuário for cadastrado com sucesso
    useEffect(() => {
    ...
    // Função para atualizar o estado da confirmação da senha
